...
export type StorageHash =
  StorageHashBase<'7fdb9e1c3420f270323e843ef8966914ea00c819750916057254966727e0cd24'>;
export type ExecutionHash =
  ExecutionHashBase<'1dc8811d026135e64a6750913ddd45866cfad344e488195a6a36567426511939'>;
...
export namespace Models {
  ...
  export type public_Category = {
    ...
    topics: public_Topic[];
    readonly [RelationKeys]?: 'section' | 'topics';
  };
  export type public_Topic = {
    ...
    readonly [RelationKeys]?: 'category' | 'problems';
  };
  export type public_Problem = {
    id: CodecTypes['pg/int4@1']['output'];
    topicId: CodecTypes['pg/int4@1']['output'];
    ...
    topic: public_Topic;
    readonly [RelationKeys]?: 'progress' | 'topic';
  };
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly category: {
              ...
              indexes: readonly [
                {
                  readonly name: 'category_sectionId_idx_5d1ea56b';
                  readonly prefix: 'category_sectionId_idx';
            ...
            readonly problem: {
              ...
              indexes: readonly [
                {
                  readonly name: 'problem_topicId_idx_6f05808f';
                  readonly prefix: 'problem_topicId_idx';
            ...
            readonly topic: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['categoryId', 'slug'] }];
              indexes: readonly [
                {
                  readonly name: 'topic_categoryId_idx_15c304f2';
                  readonly prefix: 'topic_categoryId_idx';
